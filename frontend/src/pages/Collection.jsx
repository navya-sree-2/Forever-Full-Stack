...
const Collection = () => {
    ...
    const sortProducts = () => {
        let filterProductsCpy = filterProducts.slice();
        switch(sortType) {
            case 'low-high':
                setFilterProducts(filterProductsCpy.sort((a, b) => a.price - b.price));
                break;
            case 'high-low':
                setFilterProducts(filterProductsCpy.sort((a, b) => b.price - a.price));
                break;
            default:
                applyFilter();
                break;
